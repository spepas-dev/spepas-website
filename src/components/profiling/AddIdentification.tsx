...
import React, { useEffect, useState } from 'react'; // *adjusted*
import { toast } from 'react-hot-toast'; // *adjusted*
import { useNavigate } from 'react-router-dom';

import Breadcrumb from '@/components/common/Breadcrumb';
import { getGlobalSetAuthData, useAuth } from '@/features/auth'; // *adjusted*
...
const AddIdentification: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const toastId = toast.loading('Refreshing account…', {
      // *adjusted*
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const toastId = toast.loading('Saving identification…', {
      // *adjusted*
      position: 'bottom-center' // *adjusted*
    }); // *adjusted*
