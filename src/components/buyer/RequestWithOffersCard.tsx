    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-200 flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <div className="mt-auto space-y-2 mb-4">
          ...
          {bids.length > 0 && (
            <div className="space-y-1.5">
              ...
              {bids.length > 3 && (
                <p className="text-[11px] text-gray-400 text-center">+{bids.length - 3} more</p>
              )}
            </div>
          )}
        </div>
        ...
        {bids.length > 0 ? (
          ...
          <div className="w-full text-center text-xs text-gray-400 py-2.5 bg-gray-50 rounded-xl">
            Waiting for offers...
          </div>
        )}
      </div>
