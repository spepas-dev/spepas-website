...
const Header = () => {
  ...
  const { isAuthenticated, authData, logout: handleSignOut } = useAuth();
              ...
              {isAuthenticated && (
               ...
               {isAuthenticated ? (
                <div className="flex items-center gap-4">
                  ...
                  <button onClick={handleSignOut} className="flex items-center gap-2.5">
                    <p className="font-medium text-custom-sm text-dark">Sign Out</p>
                  </button>
                </div>
              ) : (
