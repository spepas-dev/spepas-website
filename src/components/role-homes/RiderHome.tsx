    ...
    <div className="border rounded-xl p-4">
      <div className="flex items-center justify-between mb-3">
        <div className="text-gray-700">
          <span className="text-sm">Order ID:</span> <span className="font-medium">#{item.id}</span>
        </div>
      ...
      <div className="mt-4">
        {!accepted ? (
          <div className="flex gap-3">
            <button onClick={onDismiss} className="flex-1 py-2 rounded-lg border text-gray-700 hover:bg-gray-50">
              Dismiss
            </button>
            <button onClick={onAccept} className="flex-1 py-2 rounded-lg bg-violet-600 text-white hover:bg-violet-700">
              Accept
            </button>
          </div>
        ) : (
  ...
  return (
    <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0 py-6 pt-28">
      ...
      <p className="text-xs text-gray-500 mt-6">
        Signed in as <span className="font-medium">{riderName}</span>
      </p>
    </div>
  );
};
