...
const RiderDocumentsTab: React.FC = () => {
  ...
  useEffect(() => { setLocalDeliver(deliverFromAuth); }, [deliverFromAuth]);
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            ...
            {localDeliver?.front_license_url ? (
              <img src={localDeliver.front_license_url} alt="License front" className="w-full max-w-xs rounded-lg border border-gray-200 object-cover" />
            ) : (
          ...
          <div className="space-y-3">
            ...
            {localDeliver?.back_license_url ? (
              <img src={localDeliver.back_license_url} alt="License back" className="w-full max-w-xs rounded-lg border border-gray-200 object-cover" />
            ) : (
              <div className="w-full max-w-xs h-32 rounded-lg border-2 border-dashed border-gray-200 flex items-center justify-center">
                <span className="text-xs text-gray-400">No image uploaded</span>
              </div>
