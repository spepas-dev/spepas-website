    ...
    <div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl px-5 py-4 shadow-sm border border-gray-100">
          ...
          <p className="mt-1">
            <span className={`inline-flex items-center gap-1.5 text-sm font-semibold ${details.status === 1 ? 'text-green-600' : 'text-amber-600'}`}>
        ...
        <div className="bg-white rounded-xl px-5 py-4 shadow-sm border border-gray-100 sm:col-span-2">
          ...
          {details.business_reg_url ? (
            <a href={details.business_reg_url} target="_blank" rel="noreferrer" className="block text-sm font-medium text-blue hover:underline mt-1 truncate">
              View Document
            </a>
          ) : (
