  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        ...
        <p>
          <strong>Balance:</strong> GH₵ {wallet.balance.toFixed(2)}
        </p>
        <p className="text-sm text-gray-500">Created: {new Date(wallet.date_created).toLocaleString()}</p>
        <p>
          <strong>Status:</strong> {wallet.status === 1 ? 'Active' : 'Inactive'}
        </p>
      </div>
    </div>
  );
