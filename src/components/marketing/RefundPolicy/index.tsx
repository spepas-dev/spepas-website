  ...
  const sections = [
    {
      ...
      content: (
        <ol className="list-decimal list-inside space-y-2 text-gray-700">
          <li><strong>Timeframe:</strong> Initiate within 24–48 hrs of delivery; verify items on receipt.</li>
          <li><strong>Condition:</strong> Unused, original packaging, resalable condition required.</li>
          <li><strong>Exceptions:</strong> Electrical, custom, and special-import parts only if defective.</li>
          <li><strong>Proof:</strong> Valid receipt or order confirmation.</li>
        </ol>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          <li><strong>Exchanges Preferred:</strong> We’ll replace or provide equivalent item.</li>
          <li><strong>Refunds Rare:</strong> Only if seller error (defective/incorrect item).</li>
          <li><strong>Shipping:</strong> You cover return shipping unless it’s our fault.</li>
        </ul>
      )
    },
    {
