  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      <div className={`flex-wrap gap-2.5 p-6 ${toggleDropdown ? 'flex' : 'hidden'}`}>
        ...
        <label htmlFor="sizeL" className="cursor-pointer select-none flex items-center rounded-md hover:bg-blue hover:text-white">
          <div className="relative">
        ...
        <label htmlFor="sizeXL" className="cursor-pointer select-none flex items-center rounded-md hover:bg-blue hover:text-white">
          <div className="relative">
        ...
        <label htmlFor="sizeXXL" className="cursor-pointer select-none flex items-center rounded-md hover:bg-blue hover:text-white">
          <div className="relative">
