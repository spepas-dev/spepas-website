...
const QuickViewModal = () => {
  ...
  const handlePreviewSlider = () => {
    ...
    // openPreviewModal();
    console.log('handlePreviewSlider');
  };
  ...
  return (
    <div
      className={
        'z-99999 fixed top-0 left-0 overflow-y-auto no-scrollbar w-full h-screen sm:py-20 xl:py-25 2xl:py-[230px] bg-dark/70 sm:px-8 px-4 py-5'
      }
    >
          ...
          <div className="flex flex-wrap items-center gap-12.5">
              ...
              <div className="flex gap-5">
                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    ...
                    {/* <img src={product?.imgs?.previews?.[activePreview]} alt="products-details" width={400} height={400} /> */}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-5 mb-6">
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <svg className="fill-gray-4" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_375_9172)">
                        <path
                          d="M16.7906 6.72187L11.7 5.93438L9.39377 1.09688C9.22502 0.759375 8.77502 0.759375 8.60627 1.09688L6.30002 5.9625L1.23752 6.72187C0.871891 6.77812 0.731266 7.25625 1.01252 7.50938L4.69689 11.3063L3.82502 16.6219C3.76877 16.9875 4.13439 17.2969 4.47189 17.0719L9.05627 14.5687L13.6125 17.0719C13.9219 17.2406 14.3156 16.9594 14.2313 16.6219L13.3594 11.3063L17.0438 7.50938C17.2688 7.25625 17.1563 6.77812 16.7906 6.72187Z"
                          fill=""
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button
                  className={
                    'inline-flex items-center gap-2 font-medium text-white bg-dark py-3 px-6 rounded-md ease-out duration-200 hover:bg-opacity-95 '
                  }
                >
