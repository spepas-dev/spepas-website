...
const PreviewSliderModal = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        <button className="rotate-180 absolute left-100 p-5 cursor-pointer z-10 " onClick={handlePrev}>
        ...
        <button className="absolute right-100 p-5 cursor-pointer z-10" onClick={handleNext}>
          <svg width="36" height="36" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
      ...
      <Swiper ref={sliderRef} slidesPerView={1} spaceBetween={20}>
        <SwiperSlide>
          <div className="flex justify-center items-center">
            <img src={'/images/products/product-2-bg-1.png'} alt={'product image'} width={450} height={450} />
          </div>
        </SwiperSlide>
      </Swiper>
    </div>
