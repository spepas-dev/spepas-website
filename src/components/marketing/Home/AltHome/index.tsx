...
const AltHome: React.FC = () => {
  ...
  const calculateTimeLeft = () => {
    ...
    const target = new Date(`${now.getMonth() + 1}/${now.getDate()}/${thisYear + 1} 07:07:07`);
  ...
  return (
    <section className="relative w-full flex flex-col items-center bg-white">
      ...
      >
        ...
        {/* Heading */}
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-blue-400">COMING SOON</h1>

        {/* Description */}
        <p className="text-gray-700 max-w-2xl mx-auto">
          SpePas is Ghana’s online marketplace for new and used car parts. We connect buyers, sellers, and mechanics—making it easy to find
          the right part and get it delivered fast.
        </p>
